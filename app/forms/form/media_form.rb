module Form
  class MediaForm < Form::Base
    ...
    def initialize(params)
      super(params.slice(*attributes_list(:title, :description, :category, :url, :file, :original_filename, :tag_list)))
      set_preview!
    ...
    def mutually_exclusive_url_or_file
      url_present, file_present = url.present?, file.present?
    ...
    def set_preview!
      if url.present?
        ...
        self.preview = Hashie::Mash.new(title: file)
      else
