...
describe Dashboard::TopicsController do
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created topic" do
        post :create, {:topic => valid_attributes}, valid_session
        expect(response).to redirect_to(dashboard_topic_path(Topic.last))
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "redirects to the topic" do
        topic = Topic.create! valid_attributes
        put :update, {:id => topic.to_param, :topic => valid_attributes}, valid_session
        expect(response).to redirect_to(dashboard_topic_path(topic))
      end
    end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the topics list" do
      topic = Topic.create! valid_attributes
      delete :destroy, {:id => topic.to_param}, valid_session
      expect(response).to redirect_to(dashboard_topics_url)
    end
  end
