...
if Rails.env.development? || Rails.env.staging?
  ...
  Event.new(title: "1st class (opened)",start_at: 1.days.from_now, teacher: teacher, organization: org, status: "opened").save!
  ...
  Event.new(title: "4th class (opened)",start_at: 7.days.from_now, teacher: teacher, organization: org, status: "opened").save!
