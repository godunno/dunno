...
if Rails.env.development? || Rails.env.staging?
  ...
  teacher = Teacher.create!(authentication_token: "VfHCJUg1xTqhNPLyU5ym", name: "Prof. Example", email: "prof@dunno.vc", password: "#dunnovc", password_confirmation: "#dunnovc", avatar: "http://lorempixel.com/100/100/people/")
