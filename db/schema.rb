...
ActiveRecord::Schema.define(version: 20141107011329) do
  ...
  create_table "medias", force: true do |t|
    ...
    t.integer  "topic_id"
    t.json     "preview"
    t.integer  "personal_note_id"
  end

  add_index "medias", ["personal_note_id"], name: "index_medias_on_personal_note_id", using: :btree
