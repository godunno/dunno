...
ActiveRecord::Schema.define(version: 20160405153543) do
  ...
  create_table "courses", force: true do |t|
    ...
    t.integer  "file_size_limit",            default: 10485760
  end
  ...
  create_table "users", force: true do |t|
    ...
    t.string   "avatar_url"
    t.boolean  "receive_digests",        default: true
  end
  ...
  add_index "users", ["receive_digests"], name: "index_users_on_receive_digests", using: :btree
